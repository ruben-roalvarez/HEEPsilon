...
(
  ...
  logic                         rf_en;
  logic [         DP_WIDTH-1:0] rdata_reg_temp;
  ...
  assign rf_en = ce_i; // wait until end of instruction to write in the register file
  ...
  // We need to temp store the rdata before writing it to the register file
  always_ff @(posedge clk_i)
  begin
    if (rst_i == 1'b1) begin
      rdata_reg_temp <= '0;
    end else begin
      if (ce_i == 1'b0 && data_rvalid_i == 1'b1) begin
        rdata_reg_temp <= data_rdata_i;
      end
    end
  end
